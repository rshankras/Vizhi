namespace Loupedeck.VizhiPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.VizhiPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.VizhiPlugin.Resources.Resource.txt`.
